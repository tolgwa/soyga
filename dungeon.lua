-- == STABIL BAŞLANGIÇ BEKLEYİCİ (LocalScript) ==

-- 1) Oyun motoru yüklensin
...
-- 2) Player hazır olana kadar bekle
while not player do
	task.wait()
...
-- 4) Humanoid ve RootPart garanti
character:WaitForChild("Humanoid")
character:WaitForChild("HumanoidRootPart")

-- 6) Küçük güvenlik payı
task.wait(2)

print("Tüm sistemler hazır. Script güvenle başlatılabilir.")

loadstring(game:HttpGet('https://raw.githubusercontent.com/defnotry/devry-hub/refs/heads/main/loader.lua'))()
